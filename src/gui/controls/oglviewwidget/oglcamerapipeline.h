...
#ifndef CLTEM_OGLCAMERAPIPELINE_H
#define CLTEM_OGLCAMERAPIPELINE_H
...
public:
    ...
    void initPerspProjection(float fov, float width, float height, float n, float f);

    void initOrthoProjection(float t, float l, float b, float r, float n, float f);
...
#endif //CLTEM_OGLCAMERAPIPELINE_H
