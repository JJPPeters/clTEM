...
//    connect(ui->edtAperture, &QLineEdit::textChanged, this, &SourceFrame::checkEditZero);
//    connect(ui->edtDelta, &QLineEdit::textChanged, this, &SourceFrame::checkEditZero);
//    connect(ui->edtConverge, &QLineEdit::textChanged, this, &SourceFrame::checkEditZero);
...
//    connect(myDialog, &AberrationsDialog::appliedSignal, this, &SourceFrame::updateTextBoxes);
//
...
//void SourceFrame::updateAberrations()
//{
