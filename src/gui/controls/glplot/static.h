...
#ifndef CLTEM_STATIC_H
#define CLTEM_STATIC_H
...
//        Vector4f r;
//
//        r[0] = m[0][0]* v[0] + m[0][1]* v[1] + m[0][2]* v[2] + m[0][3]* v.w;
//        r[1] = m[1][0]* v[0] + m[1][1]* v[1] + m[1][2]* v[2] + m[1][3]* v.w;
//        r[2] = m[2][0]* v[0] + m[2][1]* v[1] + m[2][2]* v[2] + m[2][3]* v.w;
//        r.w = m[3][0]* v[0] + m[3][1]* v[1] + m[3][2]* v[2] + m[3][3]* v.w;
//
//        return r;
//    }
//
